...
class Runner:
    ...
    def select_mating_pool(self) -> Population:
        ...
        # mating_pool = random.choices(
        #     self.population.individuals, k=self.population.size, cum_weights=selection_probs)
